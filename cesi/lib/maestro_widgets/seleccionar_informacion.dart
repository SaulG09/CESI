...
class InformacionSeleccionMaestro extends StatefulWidget {
  final Color color1;
  final Color color2;
  final Color color3;

  const InformacionSeleccionMaestro({
    super.key,
  ...
  @override
  _InformacionSeleccionMaestroState createState() => _InformacionSeleccionMaestroState();
}

class _InformacionSeleccionMaestroState extends State<InformacionSeleccionMaestro> {
  int tipoVista = 0;
  ...
  final List<Map<String, String>> items = [
    {
      'image': 'lib/images/estudiante.webp',
      'text1': 'Alumno 1',
    },
    {
      'image': 'lib/images/estudiante.webp',
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextFieldWithIcon(Icons.phone, 'Teléfono',
                        isNumeric: true),
                    _buildTextFieldWithIcon(Iconsax.user, 'Usuario'),
                    _buildTextFieldWithIcon(
                        Iconsax.password_check, 'Contraseña',
                        isPassword: true),
                    SizedBox(height: 10),
