import 'package:cesi/maestro_widgets/asistencia_maestro.dart';
      ...
      body: tipoVista == 0
          ...
          : tipoVista == 1
              ...
              : tipoVista == 2
                  ? _buildAlumno()
                  : tipoVista == 3
                      ? Center(child: Text("Contenido no disponible"))
                      : tipoVista == 4
                          ? Center(child: Text("Contenido no disponible"))
                          : Container(), // Esto es por si el valor de tipoVista no es ninguno de los anteriores
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    // Parte superior con los dos primeros cards
                    Expanded(
                      child: Row(
                        children: [
                          Expanded(
                            child: _buildCard(
                              'lib/images/reportes.png',
                              widget.color2,
                              'Tomar asistencia',
                              () {
