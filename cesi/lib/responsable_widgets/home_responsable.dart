...
class HomeResponsable extends StatefulWidget {
  final Color color1;
  final Color color2;
  final Color color3;
  ...
  @override
  _HomeResponsableState createState() => _HomeResponsableState();
}

class _HomeResponsableState extends State<HomeResponsable> {
  int tipoVista = 0;
