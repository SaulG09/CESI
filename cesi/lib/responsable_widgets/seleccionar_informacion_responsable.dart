...
class InformacionSeleccionResponsable extends StatefulWidget {
  final Color color1;
  final Color color2;
  final Color color3;

  const InformacionSeleccionResponsable({
    super.key,
  ...
  @override
  _InformacionSeleccionResponsableState createState() => _InformacionSeleccionResponsableState();
}

class _InformacionSeleccionResponsableState extends State<InformacionSeleccionResponsable> {
  int tipoVista = 0;
